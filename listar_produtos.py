...
def listar_produtos(*lista):
    '''Percorrer uma base de dados e criar uma lista atualizada sem repetir os códigos/nomes

    Parameters:
        Uma base de dados / lista

    Return:
        Uma nova lista tratada sem repetir os códigos, criando os reais itens da listas.
     '''
    
    lista_produtos = []
    for item in lista:
        for codigo, estoque in item:
...
print(listar_produtos(estoque_fim_jan, estoque_fim_fev))
#print(len(listar_produtos(estoque_fim_jan, estoque_fim_fev)))
print(listar_produtos(estoque_fim_jan, estoque_fim_fev,estoque_fim_mar))
print(listar_produtos(estoque_fim_jan, estoque_fim_fev, estoque_fim_abr))